         ...
         @foreach($listado as $data)
            <tr>
               ...
               <td> <b>No. de Carnet:</b> {{ $data->carnet }} <br/> 
                     ...
                     <a href="/alumno/editar/{{$data->carnet}}" class="btn btn-btb-link btn-primary" style="color: white;">
                     ...
                     <a href="/alumno/borrar/{{$data->carnet}}" class="btn btn-link btn-danger" style="color: white;">
