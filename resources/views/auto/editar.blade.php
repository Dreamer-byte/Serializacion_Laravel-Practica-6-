...
@section('contenido')
    ...
    <form action="{{ url('/auto/actualizar') }}" method="post" class="col-md-6" enctype="multipart/form-data">
        {{ csrf_field() }}

        <div class="input-group">
            <label for="floatingInput" class="input-group-text">Placa del vehiculo</label>
            <input type="tex" class="form-control" id="floatingInput" name="au-placa" placeholder="Placa" readonly value="{{$au->Placa}}">
          </div>
          
          <div class="input-group">
              <label for="mc" class="input-group-text">Marca:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
            
            <input id="mc" type="text" class="form-control" name="au-marca" required placeholder="Marca" required value="{{$au->Marca}}">
          </div>
        
          <div class="input-group">
            <label for="md" class="input-group-text">Modelo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
          
          <input id="md" type="text" class="form-control" name="au-modelo" required placeholder="Modelo" required value="{{$au->Modelo}}">
        </div>
        <fieldset border="2">
            ...
            @switch($au->color)
                ...
                <input type="radio" name="au-color" id="r1" required value="Rojo" checked><br>
                ...
                <label for="r2">Negro</label>
                <input type="radio" name="au-color" id="r2" value="Negro" required checked><br>
                <label for="r3">Blanco</label>
                <input type="radio" name="au-color" id="r3" value="Blanco" required><br>
                    @break
                @case("Blanco")
                ...
                <input type="radio" name="au-color" id="r2" value="Negro" required ><br>
                <label for="r3">Blanco</label>
                <input type="radio" name="au-color" id="r3" value="Blanco" required checked><br>
                @break
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="au-foto" id="au-foto" >
        </div>
